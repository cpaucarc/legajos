$(document).ready(function () {
    ...
    $("#id_d-fecha_fin").prop("required", true);
    $("#div_id_d-fecha_fin > label").html(`Fecha fin<span class="asteriskField">*</span>`);
    $("#id_d-trabaja_actualmente").click(function () {
        $("#div_id_d-fecha_fin").show();
        $("#id_d-fecha_fin").val("");
        $("#id_d-fecha_fin").prop("required", true);
        $("#div_id_d-fecha_fin > label").html(`Fecha fin<span class="asteriskField">*</span>`);
        if ($(this).prop("checked")) {
            $("#div_id_d-fecha_fin").hide();
            $("#id_d-fecha_fin").val("");
        }
    });
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.trabaja_actualmente) {
                $("#formDocente #id_d-trabaja_actualmente").prop('checked', true);
                $("#div_id_d-fecha_fin").hide();
                $("#id_d-fecha_fin").val("");
            } else {
                $("#formDocente #id_d-trabaja_actualmente").prop('checked', false);
                $("#div_id_d-fecha_fin").show();
                $("#id_d-fecha_fin").prop("required", true);
                $("#div_id_d-fecha_fin > label").html(`Fecha fin<span class="asteriskField">*</span>`);
            }
