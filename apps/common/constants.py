...
TIPO_DOCUMENTO_FORMACION_MAESTRIA = 'formacion_maestria'
...
TIPO_DOCUMENTO_CHOICES = (
    ...
    (TIPO_DOCUMENTO_FORMACION_MAESTRIA, 'Maestrias'),
)
...
COLEGIATURA_HABILITADO = True
COLEGIATURA_INHABILITADO = False
